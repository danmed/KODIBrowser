...
$SQL3 = "select * from episode_view where idfile = '" . $episodeid . "'";
...
$SQL4 = "select * from streamdetails where idFile = '" . $idfile . "' AND iStreamType = '0'";
